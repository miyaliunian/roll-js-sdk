...
(function (global, factory) {
  ...
  var useSymbolAsUid =
    NATIVE_SYMBOL$2 && !Symbol.sham && typeof Symbol.iterator == "symbol";
  ...
  var isSymbol$3 = USE_SYMBOL_AS_UID$1
    ...
    : function (it) {
        ...
        return (
          isCallable$a($Symbol) &&
          isPrototypeOf$1($Symbol.prototype, $Object$2(it))
        );
      };
  ...
  var ordinaryToPrimitive$1 = function (input, pref) {
    ...
    if (
      ...
      !isObject$3((val = call$8(fn, input)))
    )
      return val;
    if (
  ...
  var wellKnownSymbol$4 = function (name) {
    if (
      ...
      !(NATIVE_SYMBOL$1 || typeof WellKnownSymbolsStore[name] == "string")
    ) {
  ...
  var nativeWeakMap =
    isCallable$6(WeakMap$1) && /native code/.test(inspectSource$1(WeakMap$1));
  ...
  var regexpGetFlags = function (R) {
    ...
    return flags === undefined &&
      ...
      !hasOwn$3(R, "flags") &&
      isPrototypeOf(RegExpPrototype$2, R)
      ? call$6(regExpFlags, R)
      : flags;
  };
  ...
  const jssdk = {
    config: (params) => {
      const data = {
        debug:
          params !== null && params !== void 0 && params.debug
            ? params.debug
            : false,
        appid:
          params !== null && params !== void 0 && params.appid
            ? params.appid
            : "",
        timestamp:
          params !== null && params !== void 0 && params.timestamp
            ? params.timestamp
            : "",
        nonce:
          params !== null && params !== void 0 && params.nonce
            ? params.nonce
            : "",
        signType:
          params !== null && params !== void 0 && params.signType
            ? params.signType
            : "",
        sign:
          params !== null && params !== void 0 && params.sign
            ? params.sign
            : "",
        jsApiList:
          params !== null && params !== void 0 && params.jsApiList
            ? params.jsApiList
            : [],
      };
